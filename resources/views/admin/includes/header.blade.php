        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="wd-30 ht-30 rounded-circle" src="{{ (!empty($profile->image) ? asset($profile->image) : asset('backend/upload/no_image.jpg')) }}" alt="profile">
                </a>
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                        <div class="mb-3">
                            <img class="wd-80 ht-80 rounded-circle" src="{{ (!empty($profile->image) ? asset($profile->image) : asset('backend/upload/no_image.jpg')) }}" alt="Profile">
                        </div>
                        <div class="text-center">
                            <p class="tx-16 fw-bolder">{{ $profile->name }}</p>
                            <p class="tx-12 text-muted">{{ $profile->suid }}</p>
                        </div>
                    </div>
